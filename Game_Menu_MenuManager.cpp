...
void Game::Menu::Game_Menu_MenuManager::drawFocusedMusicData() {
	...
	for (int i = 0; i < 30; ++i) {
		if (i < 10) {
			DrawBox(40 + i, 50 + i, 160 + i, 60 + i, GetColor(134 - i * 5, 134, 134), true);
		}
		DrawBox(40 + i, 71 + i, 600 + i, 81 + i, GetColor(134 - i * 2, 134, 134), true);
	}
	//選択されている難易度
	SetDrawBlendMode(DX_BLENDMODE_ALPHA, blend);
...
void Game::Menu::Game_Menu_MenuManager::setDifficultyAndBpmStr() {
	bpm = "BPM :";
