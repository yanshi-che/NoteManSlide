...
Game::File::Game_File_MusicData::Game_File_MusicData(int mHandle,std::uint16_t bp,std::uint16_t bLength,float tMinutes,std::uint16_t bDlay,std::uint8_t numOfLane) :
...
const float& Game::File::Game_File_MusicData::getTotalMinutes() noexcept{
	return totalMinutes;
}

const std::uint16_t& Game::File::Game_File_MusicData::getBeginDelay() noexcept {
	return beginDelay;
}
